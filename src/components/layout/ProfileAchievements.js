...
import { FaStar, FaBookOpen, FaFlask, FaFire, FaTrophy, FaLock, FaMedal, FaCalendarCheck, FaCode, FaUsers, FaCalculator } from 'react-icons/fa';

// Mock data (merged from previous components)
const mockBadges = [
    ...
    <section style={{
      ...
      <div style={{ display: 'flex', gap: 18, marginBottom: 24, justifyContent: 'center' }}>
        <button
          ...
          style={{
            background: tab === 'badges' ? '#ffe082' : '#f7f6f2',
            color: tab === 'badges' ? '#ff9800' : '#2d3a2e',
            border: 'none',
            borderRadius: 8,
            ...
            fontSize: 15,
            cursor: 'pointer',
            boxShadow: tab === 'badges' ? '0 1px 4px #ffe082' : 'none',
            transition: 'all 0.2s',
          }}
        >
          Badges
        ...
        <button
          ...
          style={{
            background: tab === 'progress' ? '#ffe082' : '#f7f6f2',
            color: tab === 'progress' ? '#ff9800' : '#2d3a2e',
            border: 'none',
            borderRadius: 8,
            padding: '0.5rem 1.5rem',
            fontWeight: 600,
            fontSize: 15,
            cursor: 'pointer',
            boxShadow: tab === 'progress' ? '0 1px 4px #ffe082' : 'none',
            transition: 'all 0.2s',
          }}
        >
          Progress & Milestones
      ...
      {tab === 'badges' ? (
        <div style={{
          ...
          {mockBadges.length === 0 && (
            <div style={{ color: '#888', fontSize: 14, margin: '1.5rem 0' }}>No badges yet.</div>
          )}
